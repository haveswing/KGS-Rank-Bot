...
def rank(msg):
    ...
    bot.sendPhoto(chat_id, 'https://upload.wikimedia.org/wikipedia/commons/b/b4/JPEG_example_JPG_RIP_100.jpg', caption=None, disable_notification=None, reply_to_message_id=None, reply_markup=None)
