...
def handle(msg):
    ...
    if command.startswith('/rank '):
        ...
        bot.sendMessage(chat_id, 'COMMANDS:\n/rank - Get the rank graph of a KGS player.\n/top100 - Top 100 KGS players.\n/info - About the bot...\n\nKGS RANK BOT ON GITHUB:\nhttps://github.com/haveswing/KGS-Rank-Bot\n\nKGS HOMEPAGE:\nhttps://www.gokgs.com/', parse_mode=None, disable_web_page_preview=Yes, disable_notification=None, reply_to_message_id=None, reply_markup=None)
        bot.sendPhoto(chat_id, ('haveswing.png', 'https://www.gokgs.com/servlet/graph/haveswing-en_US.png'), caption=('Developed by haveswing.\nantonio.romaggioli@gmail.com'))
    elif command == '/info@kgsrankbot':
        print chat_id, 'request info.'
        bot.sendMessage(chat_id, 'COMMANDS:\n/rank - Get the rank graph of a KGS player.\n/top100 - Top 100 KGS players.\n/info - About the bot...\n\nKGS RANK BOT ON GITHUB:\nhttps://github.com/haveswing/KGS-Rank-Bot\n\nKGS HOMEPAGE:\nhttps://www.gokgs.com/', parse_mode=None, disable_web_page_preview=None, disable_notification=None, reply_to_message_id=None, reply_markup=None)
        bot.sendPhoto(chat_id, ('haveswing.png', 'https://www.gokgs.com/servlet/graph/haveswing-en_US.png'), caption=('Developed by haveswing.\nantonio.romaggioli@gmail.com'))
    elif command == '/top100':
