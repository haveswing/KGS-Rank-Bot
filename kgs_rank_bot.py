...
def rank(msg):
    ...
    bot.sendPhoto(chat_id, "https://www.gokgs.com/servlet/graph/haveswing-en_US.png", caption=None, disable_notification=None, reply_to_message_id=None, reply_markup=None)
